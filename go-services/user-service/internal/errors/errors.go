...
var (
	...
	ErrorUnexpectedSigningMethodJWT = errors.New("unexpected signing method")
	ErrInvalidToken = errors.New("invalid jwt token")
	ErrCantParseToken = errors.New("can not parse token")
	ErrTokenNoExpiration = errors.New("token has no expiration")
	ErrTokenExpired = errors.New("token is expired")
	ErrNoUserInToken = errors.New("token dont has user id")
